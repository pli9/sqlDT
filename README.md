...
You can install the development version of sqlDT from [GitHub](https://github.com/) with:
...
This is a basic example which shows you how to create a simple `sqlDT` table:
